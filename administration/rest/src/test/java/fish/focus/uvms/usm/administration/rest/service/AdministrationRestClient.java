package fish.focus.uvms.usm.administration.rest.service;
...
import static fish.focus.uvms.usm.administration.rest.common.ExceptionHandler.handleException;
...
public class AdministrationRestClient {
    ...
    public AuthenticationResponse authenticateByChallenge(String jwtToken, ChallengeResponse request) {
        return getWebTargetInternal()
                .path("challengeauth")
                .request(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, jwtToken)
