package fish.focus.uvms.usm.administration.rest.service.authentication;
...
import fish.focus.uvms.usm.administration.rest.common.StatusResponse;
...
public class AuthenticationResourceIT extends BuildAdministrationDeployment {
    ...
    public void testAuthenticateUserByChallenge() {
        ...
        AuthenticationJwtResponse response = restClient.authenticateUser("quota_man_com", PASSWORD);
        AuthenticationResponse result = restClient.authenticateByChallenge(response.getJwtoken(), request);
