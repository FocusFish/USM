package fish.focus.uvms.usm.administration.rest.service.application;
...
public class ApplicationResourceIT extends BuildAdministrationDeployment {
    ...
    public void testGetApplicationDetails() {
        ...
        fish.focus.uvms.usm.information.domain.deployment.Application application =
                response.readEntity(fish.focus.uvms.usm.information.domain.deployment.Application.class);
